...
export class SupplierPage {
    ...
    supplier = {sname:"", address:"", phoneno:"", myForm: true};
    ...
    submitForm(value: any):void {
    	this.sqlite.create({
			...
			.then(res => {
				db.executeSql('INSERT INTO supplier VALUES(NULL,?,?,?)',[this.supplier.sname,this.supplier.address,this.supplier.phoneno])
			    .then(res => {
			      	console.log(res);
